...
if (tg_fs()->is__premium_only()) {
    if (tg_fs()->can_use_premium_code()) {
        /**
         * Title: PRO: Footer Columns 4
         * Slug: templategalaxy/bloghoot-footer-with-col-4
         * Categories: bloghoot
         */
?>
        <!-- wp:group {"metadata":{"categories":["bloghoot"],"patternName":"templategalaxy/bloghoot-footer-with-col-4","name":"Footer"},"style":{"spacing":{"padding":{"bottom":"var:preset|spacing|50","top":"3rem"}}},"backgroundColor":"black-color","textColor":"contrast","layout":{"type":"constrained","contentSize":"1180px"}} -->
        <div class="wp-block-group has-contrast-color has-black-color-background-color has-text-color has-background" style="padding-top:3rem;padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:columns {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"},"blockGap":{"top":"var:preset|spacing|70","left":"40px"}}}} -->
            <div class="wp-block-columns" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:column {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"layout":{"type":"default"}} -->
                <div class="wp-block-column" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|40"}},"typography":{"fontStyle":"normal","fontWeight":"500","fontSize":"24px"}},"textColor":"background"} -->
                    <h3 class="wp-block-heading has-background-color has-text-color" style="margin-bottom:var(--wp--preset--spacing--40);font-size:24px;font-style:normal;font-weight:500"><?php esc_html_e('Company', 'bloghoot') ?></h3>
                    <!-- /wp:heading -->
                    ...
                    <ul style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;line-height:2;text-decoration:none" class="wp-block-list is-style-hide-bullet-list-link-hover-style-secondary is-style-list-style-no-bullet has-link-color"><!-- wp:list-item -->
                        <li><a href="#"><?php esc_html_e('About Us', 'bloghoot') ?></a></li>
                        <!-- /wp:list-item -->

                        <!-- wp:list-item -->
                        <li><a href="#"><?php esc_html_e('Blog', 'bloghoot') ?></a></li>
                        <!-- /wp:list-item -->

                        <!-- wp:list-item -->
                        <li><a href="#"><?php esc_html_e('Our Team', 'bloghoot') ?></a></li>
                        <!-- /wp:list-item -->

                        <!-- wp:list-item -->
                        <li><a href="#"><?php esc_html_e('Career', 'bloghoot') ?></a></li>
                        <!-- /wp:list-item -->

                        <!-- wp:list-item -->
                        <li><a href="#"><?php esc_html_e('Contact Us', 'bloghoot') ?></a></li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->
                </div>
                ...
                <div class="wp-block-column" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|40"}},"typography":{"fontStyle":"normal","fontWeight":"500","fontSize":"24px"}},"textColor":"background"} -->
                    <h3 class="wp-block-heading has-background-color has-text-color" style="margin-bottom:var(--wp--preset--spacing--40);font-size:24px;font-style:normal;font-weight:500"><?php esc_html_e('Products', 'bloghoot') ?></h3>
                    <!-- /wp:heading -->

                    <!-- wp:list {"className":"is-style-hide-bullet-list-link-hover-style-secondary is-style-list-style-no-bullet","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"},"margin":{"top":"0","right":"0","bottom":"0","left":"0"}},"typography":{"lineHeight":2,"textDecoration":"none"},"elements":{"link":{"color":{"text":"var:preset|color|foreground-alt"},":hover":{"color":{"text":"var:preset|color|primary"}}}}}} -->
                    <ul style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;line-height:2;text-decoration:none" class="wp-block-list is-style-hide-bullet-list-link-hover-style-secondary is-style-list-style-no-bullet has-link-color"><!-- wp:list-item -->
                        <li><a href="#"><?php esc_html_e('Fashion Hunt', 'bloghoot') ?></a></li>
                        <!-- /wp:list-item -->

                        <!-- wp:list-item -->
                        <li><a href="#"><?php esc_html_e('Daily Newspaper', 'bloghoot') ?></a></li>
                        <!-- /wp:list-item -->

                        <!-- wp:list-item -->
                        <li><a href="#"><?php esc_html_e('Weekly Magazine', 'bloghoot') ?></a></li>
                        <!-- /wp:list-item -->

                        <!-- wp:list-item -->
                        <li><a href="#"><?php esc_html_e('E-Magazine', 'bloghoot') ?></a></li>
                        <!-- /wp:list-item -->

                        <!-- wp:list-item -->
                        <li><a href="#"><?php esc_html_e('Press &amp; Newsroom', 'bloghoot') ?></a></li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->
                </div>
                ...
                <!-- wp:column {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"layout":{"type":"default"}} -->
                <div class="wp-block-column" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|40"}},"typography":{"fontStyle":"normal","fontWeight":"500","fontSize":"24px"}},"textColor":"background"} -->
                    <h3 class="wp-block-heading has-background-color has-text-color" style="margin-bottom:var(--wp--preset--spacing--40);font-size:24px;font-style:normal;font-weight:500"><?php esc_html_e('Categories', 'bloghoot') ?></h3>
                    <!-- /wp:heading -->

                    <!-- wp:categories {"showPostCounts":true,"className":"is-style-bloghoot-categories-bullet-hide-style-white-color","style":{"spacing":{"margin":{"top":"0","bottom":"0","left":"0","right":"0"},"padding":{"right":"0","left":"0"}},"typography":{"lineHeight":"1.7"}}} /-->
                </div>
                <!-- /wp:column -->

                <!-- wp:column {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"layout":{"type":"default"}} -->
                <div class="wp-block-column" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|40"}},"typography":{"fontStyle":"normal","fontWeight":"500","fontSize":"24px"}},"textColor":"background"} -->
                    <h3 class="wp-block-heading has-background-color has-text-color" style="margin-bottom:var(--wp--preset--spacing--40);font-size:24px;font-style:normal;font-weight:500"><?php esc_html_e('Support', 'bloghoot') ?></h3>
                    <!-- /wp:heading -->
                    ...
                    <ul style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;line-height:2" class="wp-block-list is-style-hide-bullet-list-link-hover-style-secondary is-style-list-style-no-bullet has-link-color"><!-- wp:list-item -->
                        <li><a href="#"><?php esc_html_e('Privacy Policy', 'bloghoot') ?></a></li>
                        <!-- /wp:list-item -->

                        <!-- wp:list-item -->
                        <li><a href="#"><?php esc_html_e('Term &amp; Conditions', 'bloghoot') ?></a></li>
                        <!-- /wp:list-item -->

                        <!-- wp:list-item -->
                        <li><a href="#"><?php esc_html_e('Support', 'bloghoot') ?></a></li>
                        <!-- /wp:list-item -->
                    </ul>
                    <!-- /wp:list -->
                </div>
            ...
            <div class="wp-block-group" style="border-top-color:var(--wp--preset--color--gray-color);border-top-width:1px;margin-top:60px;padding-top:0px;padding-right:0;padding-bottom:16px;padding-left:0"><!-- wp:social-links {"iconColor":"light-color","iconColorValue":"#FFFFFE","openInNewTab":true,"className":"is-style-logos-only","style":{"spacing":{"blockGap":{"top":"0","left":"20px"},"margin":{"right":"0","left":"0","top":"40px"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
                ...
                <p class="has-foreground-alt-color has-text-color"><?php esc_html_e('Proudly powered by WordPress | bloghoot - Made with Love by WebsiteinWP.', 'bloghoot') ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
        </div>
