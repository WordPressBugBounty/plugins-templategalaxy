...
if (tg_fs()->is__premium_only()) {
    if (tg_fs()->can_use_premium_code()) {
         ...
         * Slug: templategalaxy/wydeggrid-post-carousel
         * Categories: wydegrid
         */
?>
        <!-- wp:group {"metadata":{"categories":["wydegrid"],"patternName":"templategalaxy/zerion-post-carousel-overlay","name":"PRO: Post Carousel Overlay"},"style":{"spacing":{"padding":{"right":"var:preset|spacing|40","left":"var:preset|spacing|40","top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
